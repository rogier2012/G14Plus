...
\fancyhead[C]{C. Bogaard, van den, D. Ikink, R. Monshouwer, F.Seuren: \shorttitle} % Custom header text
...
\author{
\large
\textsc{Christiaan van den Bogaard, Dion Ikink, Fleur Seuren, \& Rogier Monshouwer}\thanks{Tutor: Jasper de Jong}\\[2mm] % Your name
...
\normalsize\href{mailto:f.seuren@student.utwente.nl}{f.m.seuren@student.utwente.nl}, % Your email addresses
...
Door $C'$ te vervangen door alle $C'_{i} = C' \cup D$ is blablabalbabala
\end{theorem}
